...
def print_html_result(result, filter_string):
  ...
  out("""
    ...
    <TR>    
        <TH COLSPAN=9>Для колонки результата: Красный - ошибка сквида, фиолетовый - ошибка сайта в интернете, зелёный - всё хорошо. Для колонки доменной авторизации при авторизации по разрешённым сайтам или по IP - логина не будет и это нормально.</TH>
    </TR>
    <TR>
